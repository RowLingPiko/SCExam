package cn.voidtech.videoservice.utils;
...
public class VideoUtil {
     ...
     * @return
     */
    public static boolean getTargetThumbnail(String localPath, String targetPath, float second) {
        ...
        try {
            ...
            // 此处可自定义视频的秒数
            ffmpeg.addArgument(String.valueOf(second));
